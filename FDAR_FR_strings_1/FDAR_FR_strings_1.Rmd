---
title: 'Travailler avec les Chaînes de Caractères en R'
output:
  html_document:
...
hiv_dat_messy_1 <- openxlsx::read.xlsx(here::here("data/hiv_dat_messy_1.xlsx")) %>%
  as_tibble()
...
```{r}
lima_messy_1 <- openxlsx::read.xlsx(here::here("data/lima_messy_1.xlsx")) %>% 
  as_tibble()
lima_messy_1
```
...
```{r}
irs <- read_csv(here::here("data/Illovo_data.csv"))
