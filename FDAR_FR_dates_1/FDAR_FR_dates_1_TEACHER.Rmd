...
```{r}
as.Date("2023-01-01") - as.Date("2020-02-01")
```
...
```{r}
parse_date_time("01/04/2020", orders = "dmy")
```
...
```{r}
parse_date_time(c("01 April 2020", "May 05/2021"), orders = c("dmy", "mdy"))
```
...
‣ Utilisons `end_date_default` et formatons-le en **Mois JJ, AAAA**.
